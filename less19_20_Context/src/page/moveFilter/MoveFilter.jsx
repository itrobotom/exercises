...
import { FilterContext, FilterDispatchContext } from "../../components/Context";
  ...
  return (
    <FilterContext.Provider value={stateFilter}>
      <div className="filter">
        ...
        {/* каждому селекту добавляется уникальный ключ после сборса, чтобы сбрасывался стейт (правило сброса) */}
        <Select 
